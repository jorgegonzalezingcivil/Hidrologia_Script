...
path_input = 'C:/JLGC/R.LTWB/.datasets/IDEAM_EDA/'  # Current location from pivot tables
station_file = path_input + pivot_table_name  # Current pivot IDEAM records file for a specified parameter
path = 'C:/JLGC/R.LTWB/.datasets/IDEAM_Outlier2/'  # Your local output path, use ../.datasets/IDEAM_Outlier/ for relative path
...
q1_val = 0.08 # Default is 0.25. Method 1.
q3_val = 0.95 # Default is 0.75. Method 1.
